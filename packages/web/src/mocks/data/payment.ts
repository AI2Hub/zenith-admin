...
export const mockPaymentLogs: PaymentNotifyLog[] = [
  { id: 1, channel: 'wechat', scene: 'payment', orderNo: 'PAY1700000000001', signatureValid: true, result: 'success', message: null, ip: '127.0.0.1', createdAt: SEED },
  { id: 2, channel: 'wechat', scene: 'refund', orderNo: 'PAY1700000000003', signatureValid: true, result: 'refunded', message: null, ip: '127.0.0.1', createdAt: SEED },
];
