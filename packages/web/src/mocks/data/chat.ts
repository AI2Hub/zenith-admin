...
export const mockChatMessages: ChatMessage[] = [
  ...
  },
  {
    ...
    extra: {
      ...
      card: {
        title: '待办审批提醒',
        text: '流程「张三的请假申请 - 年假 3 天」需要你审批',
        fields: [{ label: '审批节点', value: '管理员审批' }],
        actions: [
          { key: 'approve', label: '同意', theme: 'primary', action: 'workflow:approve', taskId: 1 },
          { key: 'reject', label: '驳回', theme: 'danger', action: 'workflow:reject', taskId: 1, requireComment: true },
        ],
        source: '工作流',
        status: 'pending',
        instanceId: 1,
    ...
    reactions: [],
    createdAt: '2026-06-22 22:42:40',
    updatedAt: '2026-06-22 22:42:40',
  },
  {
    id: 6,
    conversationId: 1,
    ...
    extra: {
      ...
      card: {
        title: '审批通过',
        text: '你发起的流程「年假申请 - 管理员 - 2026-06-20」已审批通过',
        source: '工作流',
        status: 'done',
        statusText: '已通过',
        instanceId: 9001,
    ...
    reactions: [],
    createdAt: '2026-06-22 23:10:00',
    updatedAt: '2026-06-22 23:10:00',
  },
];
