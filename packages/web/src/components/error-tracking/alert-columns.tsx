...
import { AlertChannelTags, ErrorLevelTag, ErrorTypeTag } from './issue-atoms';
...
export function errorAlertRuleColumns(actions: ErrorAlertRuleColumnActions): ColumnProps<ErrorAlertRule>[] {
  return [
    ...
    { title: '渠道', dataIndex: 'channels', width: 180, render: (_value, record) => <AlertChannelTags channels={record.channels} /> },
