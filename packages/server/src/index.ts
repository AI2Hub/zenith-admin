...
import paymentRiskOpsRoutes from './routes/payment/payment-risk-ops';
import paymentAccountRoutes from './routes/payment/payment-accounts';
...
app.route('/api/payment/risk', paymentRiskOpsRoutes);
