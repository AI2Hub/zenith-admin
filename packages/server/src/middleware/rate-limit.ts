...
export type RateLimitName = 'auth' | 'captcha' | 'sensitive' | 'report_public_share' | 'chat_send';
...
/** 内置规则名称集合（不可删除） */
export const PREDEFINED_NAMES = new Set(['auth', 'captcha', 'sensitive', 'report_public_share', 'chat_send']);
