...
export const SEED_MENUS_SYSTEM: Menu[] = [
  ...
  { id: 1110, parentId: 1000, title: '接口权限矩阵', name: 'SystemPermissionMatrix', path: '/system/permission-matrix', component: 'system/permission-matrix/PermissionMatrixPage', icon: 'Grid3x3', type: 'menu', sort: 5, status: 'enabled', visible: true, createdAt: SEED_DATE, updatedAt: SEED_DATE },
