...
export const SEED_MENUS_SETTINGS: Menu[] = [
  ...
  { id: 2740, parentId: 2120, title: '模拟登录记录', name: 'SystemImpersonationRecords', path: '/system/impersonation-records', component: 'system/impersonation/ImpersonationRecordsPage', icon: 'VenetianMask', type: 'menu', sort: 5, status: 'enabled', visible: true, createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 2741, parentId: 2740, title: '查询', type: 'button', permission: 'system:impersonation:list', sort: 0, status: 'enabled', visible: true, createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 2742, parentId: 2740, title: '强制结束', type: 'button', permission: 'system:impersonation:forceEnd', sort: 1, status: 'enabled', visible: true, createdAt: SEED_DATE, updatedAt: SEED_DATE },
  ...
  { id: 2393, parentId: 2390, title: '编辑策略', type: 'button', permission: 'system:data-mask:update', sort: 1, status: 'enabled', visible: true, createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 2395, parentId: 2390, title: '免脱敏查看', type: 'button', permission: 'system:data-mask:bypass', sort: 2, status: 'enabled', visible: true, createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 2396, parentId: 2390, title: '按需查看明文', type: 'button', permission: 'system:data-mask:reveal', sort: 3, status: 'enabled', visible: true, createdAt: SEED_DATE, updatedAt: SEED_DATE },
