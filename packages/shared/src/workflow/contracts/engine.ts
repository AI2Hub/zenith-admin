...
export const workflowEngineContract = defineContract('/api/workflows/engine', {
  ...
  runAction: op.post('/actions/{action}', { params: workflowEngineActionParam, body: workflowEngineActionFilterSchema, response: workflowEngineActionResultSchema, summary: '提交流程引擎恢复补投（支持按实例 / 入库时长 / 上限筛选）' }),
