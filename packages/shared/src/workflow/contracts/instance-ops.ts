...
export const workflowInstanceOpsContract = defineContract('/api/workflows', {
  ...
  skipToken: op.post('/instances/tokens/{id}/skip', { access: { permission: 'workflow:instance:monitor' }, audit: '跳过卡死执行 Token', params: idParam, body: workflowTokenOpSchema, response: workflowInstanceSchema, summary: '跳过卡死的执行 Token' }),
  replayToken: op.post('/instances/tokens/{id}/replay', { access: { permission: 'workflow:instance:cancel' }, audit: '从执行 Token 重放流程', params: idParam, body: workflowTokenOpSchema, response: workflowInstanceSchema, summary: '从执行 Token 节点重放流程' }),
  jump: op.post('/instances/{id}/jump', { access: { permission: 'workflow:instance:cancel' }, audit: '强制跳转流程节点', params: idParam, body: jumpWorkflowInstanceSchema, response: workflowInstanceSchema, summary: '管理员强制跳转节点' }),
  suspend: op.post('/instances/{id}/suspend', { access: { permission: 'workflow:engine:operate' }, audit: '挂起流程实例', params: idParam, body: suspendWorkflowInstanceSchema, response: workflowInstanceSchema, summary: '挂起流程实例' }),
  resume: op.post('/instances/{id}/resume', { access: { permission: 'workflow:engine:operate' }, audit: '恢复挂起流程实例', params: idParam, response: workflowInstanceSchema, summary: '恢复挂起的流程实例' }),
