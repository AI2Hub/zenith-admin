...
export const workflowTaskContract = defineContract('/api/workflows', {
  ...
  batchApprove: op.post('/tasks/batch-approve', { access: { permission: 'workflow:task:handle' }, audit: '批量审批通过', body: batchApproveWorkflowTaskSchema, response: workflowBatchActionResponseSchema, summary: '批量审批通过' }),
  ...
  approve: op.post('/tasks/{taskId}/approve', { access: { permission: 'workflow:task:handle' }, audit: '审批通过', params: workflowTaskIdParam, body: approveWorkflowTaskSchema, response: workflowInstanceSchema, summary: '审批通过' }),
  ...
  reject: op.post('/tasks/{taskId}/reject', { access: { permission: 'workflow:task:handle' }, audit: '审批驳回', params: workflowTaskIdParam, body: rejectWorkflowTaskSchema, response: workflowInstanceSchema, summary: '审批驳回' }),
  transfer: op.post('/tasks/{taskId}/transfer', { access: { permission: 'workflow:task:handle' }, audit: '转办任务', params: workflowTaskIdParam, body: transferWorkflowTaskSchema, response: workflowTaskSchema, summary: '转办' }),
  reassign: op.post('/tasks/{taskId}/reassign', { access: { permission: 'workflow:instance:cancel' }, audit: '改派审批处理人', params: workflowTaskIdParam, body: reassignWorkflowTaskSchema, response: workflowTaskSchema, summary: '管理员改派处理人' }),
  recall: op.post('/tasks/{taskId}/recall', { access: { permission: 'workflow:task:handle' }, audit: '撤回已办', params: workflowTaskIdParam, body: recallWorkflowTaskSchema, response: workflowInstanceSchema, summary: '撤回已办' }),
  ...
  delegate: op.post('/tasks/{taskId}/delegate', { access: { permission: 'workflow:task:handle' }, audit: '委派任务', params: workflowTaskIdParam, body: delegateWorkflowTaskSchema, response: workflowTaskSchema, summary: '委派' }),
  ...
  returnTask: op.post('/tasks/{taskId}/return', { access: { permission: 'workflow:task:handle' }, audit: '退回任务', params: workflowTaskIdParam, body: returnWorkflowTaskSchema, response: workflowInstanceSchema, summary: '退回' }),
