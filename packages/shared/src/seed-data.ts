...
export const SEED_MENUS: Menu[] = [
  ...
  { id: 493, parentId: 230, title: '健康巡检', name: 'WorkflowHealth', path: '/workflow/health', component: 'workflow/health/WorkflowHealthPage', icon: 'Activity', type: 'menu', sort: 8, status: 'enabled', visible: true, permission: 'workflow:health:view', createdAt: SEED_DATE, updatedAt: SEED_DATE },
  ...
  { id: 930, parentId: 230, title: '连接器',     name: 'WorkflowConnectors', path: '/workflow/connectors', component: 'workflow/connectors/WorkflowConnectorsPage', icon: 'Cable', type: 'menu', sort: 12, status: 'enabled', visible: true, permission: 'workflow:connector:list', createdAt: SEED_DATE, updatedAt: SEED_DATE },
