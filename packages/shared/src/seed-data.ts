...
export const SEED_MENUS: Menu[] = [
  ...
  { id: 110, parentId: 200, title: '邮件配置',   name: 'SystemEmailConfig',   path: '/system/email-config',       component: 'system/email-config/EmailConfigPage',            icon: 'Mail',              type: 'menu',      sort: 2,  status: 'enabled', visible: true,  permission: 'system:email-config:view',     createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 111, parentId: 110, title: '保存配置',   name: undefined,             path: undefined,                    component: undefined,                                        icon: undefined,           type: 'button',    sort: 1,  status: 'enabled', visible: true,  permission: 'system:email-config:update',   createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 112, parentId: 110, title: '测试邮件',   name: undefined,             path: undefined,                    component: undefined,                                        icon: undefined,           type: 'button',    sort: 2,  status: 'enabled', visible: true,  permission: 'system:email-config:update',   createdAt: SEED_DATE, updatedAt: SEED_DATE },
  ...
  { id: 35, parentId: 200, title: '通知公告',   name: 'SystemNotices',       path: '/system/notices',            component: 'system/notices/NoticesPage',                     icon: 'BellRing',          type: 'menu',      sort: 10, status: 'enabled', visible: true,  permission: 'system:notice:list',           createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 61, parentId: 35, title: '新增公告',   name: undefined,             path: undefined,                    component: undefined,                                        icon: undefined,           type: 'button',    sort: 1,  status: 'enabled', visible: true,  permission: 'system:notice:create',         createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 62, parentId: 35, title: '编辑公告',   name: undefined,             path: undefined,                    component: undefined,                                        icon: undefined,           type: 'button',    sort: 2,  status: 'enabled', visible: true,  permission: 'system:notice:update',         createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 63, parentId: 35, title: '删除公告',   name: undefined,             path: undefined,                    component: undefined,                                        icon: undefined,           type: 'button',    sort: 3,  status: 'enabled', visible: true,  permission: 'system:notice:delete',         createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 7,  parentId: 2,  title: '组件示例',   name: 'Components',          path: '/components',                component: 'components/ComponentsPage',                      icon: 'Component',         type: 'menu',      sort: 8,  status: 'enabled', visible: true,  createdAt: SEED_DATE, updatedAt: SEED_DATE },
  ...
  { id: 203, parentId: 0, title: '通知中心',   name: 'Notifications',       path: '/notifications',             component: 'notifications/NotificationsPage',                icon: 'Bell',              type: 'menu',      sort: 100, status: 'enabled', visible: false, createdAt: SEED_DATE, updatedAt: SEED_DATE },
  ...
  { id: 220, parentId: 200, title: '消息模板',   name: 'SystemMessageTemplates', path: '/system/message-templates', component: 'system/message-templates/MessageTemplatesPage', icon: 'Mail',              type: 'menu',      sort: 13, status: 'enabled', visible: true,  permission: 'system:message-template:list', createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 221, parentId: 220, title: '新增模板',   name: undefined,             path: undefined,                    component: undefined,                                        icon: undefined,           type: 'button',    sort: 1,  status: 'enabled', visible: true,  permission: 'system:message-template:create', createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 222, parentId: 220, title: '编辑模板',   name: undefined,             path: undefined,                    component: undefined,                                        icon: undefined,           type: 'button',    sort: 2,  status: 'enabled', visible: true,  permission: 'system:message-template:update', createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 223, parentId: 220, title: '删除模板',   name: undefined,             path: undefined,                    component: undefined,                                        icon: undefined,           type: 'button',    sort: 3,  status: 'enabled', visible: true,  permission: 'system:message-template:delete', createdAt: SEED_DATE, updatedAt: SEED_DATE },
  ...
  { id: 302, parentId: 300, title: 'AI 侧边栏',   name: 'AiSidebar',               path: '/ai/sidebar',                component: 'ai/sidebar/AISidebarPage',                       icon: 'PanelRight',        type: 'menu',      sort: 2,  status: 'enabled', visible: true,  createdAt: SEED_DATE, updatedAt: SEED_DATE },
...
export const SEED_DICTS: Dict[] = [
  ...
  { id: 6, name: '通知类型',     code: 'notice_type',           description: '通知公告类型',       status: 'enabled', createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 7, name: '通知发布状态', code: 'notice_publish_status', description: '通知公告的发布状态', status: 'enabled', createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 8, name: '通知优先级',   code: 'notice_priority',       description: '通知公告优先级',     status: 'enabled', createdAt: SEED_DATE, updatedAt: SEED_DATE },
