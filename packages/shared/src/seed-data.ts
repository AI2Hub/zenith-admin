...
export const SEED_MENUS: Menu[] = [
  ...
  // 频道管理（站内公众号）
  { id: 460, parentId: 400, title: '频道管理',     name: 'NotificationChannels', path: '/system/channels',              component: 'system/channels/ChannelsPage',                           icon: 'Radio',             type: 'menu',      sort: 4,  status: 'enabled', visible: true,  permission: 'channel:channel:list',             createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 461, parentId: 460, title: '新建频道',     name: undefined,              path: undefined,                       component: undefined,                                                icon: undefined,           type: 'button',    sort: 1,  status: 'enabled', visible: true,  permission: 'channel:channel:create',           createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 462, parentId: 460, title: '编辑频道',     name: undefined,              path: undefined,                       component: undefined,                                                icon: undefined,           type: 'button',    sort: 2,  status: 'enabled', visible: true,  permission: 'channel:channel:update',           createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 463, parentId: 460, title: '删除频道',     name: undefined,              path: undefined,                       component: undefined,                                                icon: undefined,           type: 'button',    sort: 3,  status: 'enabled', visible: true,  permission: 'channel:channel:delete',           createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 464, parentId: 460, title: '群发消息',     name: undefined,              path: undefined,                       component: undefined,                                                icon: undefined,           type: 'button',    sort: 4,  status: 'enabled', visible: true,  permission: 'channel:message:publish',          createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 493, parentId: 460, title: '菜单配置',     name: undefined,              path: undefined,                       component: undefined,                                                icon: undefined,           type: 'button',    sort: 5,  status: 'enabled', visible: true,  permission: 'channel:menu:save',                createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 494, parentId: 460, title: '自动回复',     name: undefined,              path: undefined,                       component: undefined,                                                icon: undefined,           type: 'button',    sort: 6,  status: 'enabled', visible: true,  permission: 'channel:reply:list',               createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 495, parentId: 460, title: '保存自动回复', name: undefined,              path: undefined,                       component: undefined,                                                icon: undefined,           type: 'button',    sort: 7,  status: 'enabled', visible: true,  permission: 'channel:reply:save',               createdAt: SEED_DATE, updatedAt: SEED_DATE },
  { id: 496, parentId: 460, title: '删除自动回复', name: undefined,              path: undefined,                       component: undefined,                                                icon: undefined,           type: 'button',    sort: 8,  status: 'enabled', visible: true,  permission: 'channel:reply:delete',             createdAt: SEED_DATE, updatedAt: SEED_DATE },
