...
export const analyticsExperimentContract = defineContract('/api/analytics', {
  ...
  experiments: op.get('/experiments', { access: { permission: 'analytics:view' }, query: analyticsExperimentListQuery, response: paginated(analyticsExperimentSchema), summary: 'A/B 实验列表' }),
  experimentDetail: op.get('/experiments/{id}', { access: { permission: 'analytics:view' }, params: idParam, response: analyticsExperimentSchema, summary: 'A/B 实验详情' }),
  createExperiment: op.post('/experiments', { access: { permission: 'analytics:manage' }, audit: '创建 A/B 实验', body: createAnalyticsExperimentSchema, response: analyticsExperimentSchema, summary: '创建 A/B 实验' }),
  updateExperiment: op.put('/experiments/{id}', { access: { permission: 'analytics:manage' }, audit: '更新 A/B 实验', params: idParam, body: updateAnalyticsExperimentSchema, response: analyticsExperimentSchema, summary: '更新 A/B 实验' }),
  removeExperiment: op.delete('/experiments/{id}', { access: { permission: 'analytics:manage' }, audit: '删除 A/B 实验', params: idParam, summary: '删除 A/B 实验' }),
  startExperiment: op.post('/experiments/{id}/start', { access: { permission: 'analytics:manage' }, audit: '启动 A/B 实验', params: idParam, response: analyticsExperimentSchema, summary: '启动 A/B 实验' }),
  pauseExperiment: op.post('/experiments/{id}/pause', { access: { permission: 'analytics:manage' }, audit: '暂停 A/B 实验', params: idParam, response: analyticsExperimentSchema, summary: '暂停 A/B 实验' }),
  completeExperiment: op.post('/experiments/{id}/complete', { access: { permission: 'analytics:manage' }, audit: '完成 A/B 实验', params: idParam, response: analyticsExperimentSchema, summary: '完成 A/B 实验' }),
  experimentReport: op.get('/experiments/{id}/report', { access: { permission: 'analytics:view' }, params: idParam, query: analyticsExperimentReportQuery, response: analyticsExperimentReportSchema, summary: 'A/B 实验报告' }),
