    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '模型接入', link: '/ai-platform/providers' },
          { text: '智能体', link: '/ai-platform/agents' },
          { text: '知识库 RAG', link: '/ai-platform/knowledge' },
          { text: '工具与函数调用', link: '/ai-platform/tools' },
          { text: '提示词模板', link: '/ai-platform/prompts' },
          { text: '模型评测', link: '/ai-platform/eval' },
          { text: 'Mastra Studio', link: '/ai-platform/studio' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '会话回放', link: '/analytics/session-replay' },
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: '智能问数 ChatBI', link: '/report/chatbi' },
            ],
          },
          {
            text: '平台治理',
            items: [
              { text: '指标中心', link: '/report/metrics' },
              { text: '数据质量', link: '/report/quality' },
              { text: '数据填报', link: '/report/fill' },
              { text: '资源治理', link: '/report/governance' },
              { text: '资产目录', link: '/report/assets' },
            ],
          },
          {
            text: '运行时',
            items: [
              { text: '取数运行时与可靠投递', link: '/report/runtime-governance' },
            ],
          },
        ],
      },
